...
public class BounceBack : MonoBehaviour {
	...
	public void Bounce(Collision obj, int strength){
		this.GetComponent<Rigidbody>().AddForce(Vector3.Reflect(transform.position,obj.contacts[0].normal) * strength, ForceMode.Acceleration);//this causes the ball to reflect off the surface
